$(document).ready(function () {
    // 填充博文分类信息
    $.ajax({
        url: "http://192.168.1.3:80/api/category/list",
        type: "GET",
        dataType: "json",
    ...
    $.ajax({
        type: "get",
        url: "http://192.168.1.3:80/api/article/list",
        dataType: "json",
        success: function (json) {
            $.each(json, function (i, item) {
...
document.getElementById("articleCategories").onchange = function () {
    ...
    //	alert(categoryId);
    if (categoryId === "") {
        var url = "http://192.168.1.3:80/api/article/list";
    } else {
        var url = "http://192.168.1.3:80/api/article/list/sort/" + categoryId;
    }
    // 填充博文分类信息
    $.ajax({
        url: url,
...
$('#confirmBtn').click(function () {
    ...
    $.ajax({
        type: "DELETE",
        url: "http://192.168.1.3:80/admin/article/" + id,
        success: function () {
            // 刷新页面
            location.reload();
        }
...
$('#updateBtn').click(function () {
    ...
    $.ajax({
        type: "PUT",
        url: "http://192.168.1.3:80/admin/article/" + articleId,
        dataType: "json",
...
$('#addArticleBtn').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "http://192.168.1.3:80/admin/article/",
        dataType: "json",
        contentType: "application/json;charset=utf-8",
        data: JSON.stringify(article),
        success: function () {
