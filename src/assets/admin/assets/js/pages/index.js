$(document).ready(function () {
    ...
    // 填充浏览统计数据
    $.ajax({
        url: "http://192.168.1.3:80/admin/sys/view",
        type: "GET",
        dataType: "json",
    ...
    // 填充日志统计数据
    $.ajax({
        url: "http://192.168.1.3:80/admin/sys/log",
        type: "GET",
        dataType: "json",
        success: function (json) {
    ...
    // 填充评论统计数据
    $.ajax({
        url: "http://192.168.1.3:80/api/comment/list",
        type: "GET",
        dataType: "json",
        success: function (json) {
...
$('#confirmBtn').click(function () {
    ...
    $.ajax({
        type: "DELETE",
        url: "http://192.168.1.3:80/admin/comment/" + id,
        success: function () {
            // 刷新页面
            location.reload();
        }
